...
const BASE_PRODUCTS: SeedProduct[] = [
  { sku: 'MS-001', name: 'Logitech G Pro X Superlight 2', category: 'Mouse', price: 5290, stock: 25, description: 'เมาส์ไร้สายน้ำหนักเบาเพียง 60 กรัม เซนเซอร์ HERO 2 ความละเอียดสูงสุด 44,000 DPI', images: [IMG + 'ms-001.jpg', IMG + 'ms-001-2.jpg', IMG + 'ms-001-3.jpg', IMG + 'ms-001-4.jpg'] },
  ...
  { sku: 'HS-002', name: 'SteelSeries Arctis Nova Pro', category: 'Headset', price: 11900, stock: 5, description: 'หูฟังระดับไฮเอนด์พร้อม GameDAC Gen 2 และเสียงระดับ Hi-Res', images: [IMG + 'hs-002.jpg', IMG + 'hs-002-2.jpg', IMG + 'hs-002-3.jpg', IMG + 'hs-002-4.jpg'] },
  ...
  { sku: 'CH-002', name: 'Anda Seat Kaiser 3', category: 'Chair', price: 14900, stock: 11, description: 'เก้าอี้เกมมิ่งไซซ์ใหญ่ ที่วางแขน 4D พนักพิงเอนได้ 155 องศา', images: [IMG + 'ch-002.jpg', IMG + 'ch-002-2.jpg', IMG + 'ch-002-3.jpg', IMG + 'ch-002-4.jpg'] },
...
/** Base catalog plus the long-form content (overview, highlights, specs) from product-content.ts. */
export const PRODUCTS: SeedProduct[] = BASE_PRODUCTS.map((p) => ({ ...p, ...PRODUCT_CONTENT[p.sku] }));
